  ...
  function renderAlbums(){
    ...
    if(!document.getElementById("musicV7SingleStyle")){
      ...
      st.textContent =
        ...
        +".music-v7-shelf-row-final{padding-bottom:calc(170px + env(safe-area-inset-bottom))}"
        +".music-v7-restricted-grid{display:grid;grid-template-columns:minmax(0,320px);justify-content:center;gap:18px;margin:0 auto 48px;width:100%;min-width:0}"
        +".music-v7-restricted-grid .music-v7-album-art{width:100%;max-width:320px;min-width:0;justify-self:center}"
        +".music-v7-restricted-grid .music-v7-jacket{width:100%;aspect-ratio:1/1;background:transparent}"
        +".music-v7-restricted-grid .music-v7-jacket img{width:100%;height:100%;object-fit:contain!important;display:block}"
        +"@media(max-width:375px){"
          +".music-v7-album-grid-final{grid-template-columns:repeat(2,minmax(0,1fr))!important;column-gap:8px!important}"
          ...
          +".music-v7-restricted-grid{grid-template-columns:minmax(0,240px);margin-bottom:44px}"
          +".music-v7-restricted-grid .music-v7-album-art{max-width:240px}"
        +"}"
        +"@media(max-width:340px),(max-height:640px){"
          +".music-v7-album-grid-final{grid-template-columns:repeat(2,minmax(0,1fr))!important;column-gap:7px!important}"
          +".music-v7-restricted-grid{grid-template-columns:minmax(0,220px);margin-bottom:44px}"
          +".music-v7-restricted-grid .music-v7-album-art{max-width:220px}"
        +"}";
