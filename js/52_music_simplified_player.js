...
(function(){
  ...
  function renderPlayer(){
    ...
    list.innerHTML =
      ...
      + '<button id="musicV7Prev">-30</button>'
      + '<button id="musicV7Play" class="play">▶</button>'
      + '<button id="musicV7Next">+30</button>'
  ...
  function bindPlayer(){
    ...
    var prevB = $("musicV7Prev"); if(prevB) prevB.onclick = function(){ seekBy(-30); };
    var nextB = $("musicV7Next"); if(nextB) nextB.onclick = function(){ seekBy(30); };
