...
(function(){
  ...
  function polishShelf(){
    ...
    if(fav){
      ...
      fav.style.touchAction = "manipulation";
  ...
  function boot(){
    ["touchstart","pointerdown","mousedown","click","touchend","pointerup"].forEach(function(type){
      document.addEventListener(type, guardAlbumTap, {capture:true, passive:false});
    });
    polishShelf();
