...
(function(){
  ...
  function ensureRandomButton(){ ensureRandomPanelStyle(); var btn=$("cardRandomTestButton"); if(btn){ btn.style.display=(isCardMode() && localStorage.getItem("megane_developer_mode_v1")==="1")?"block":"none"; return; } btn=document.createElement("button"); btn.id="cardRandomTestButton"; btn.type="button"; btn.textContent="🎲"; btn.title="ランダム検査"; btn.onclick=function(e){ e.preventDefault(); e.stopPropagation(); showRandomPanel(); }; document.body.appendChild(btn); btn.style.display=(isCardMode() && localStorage.getItem("megane_developer_mode_v1")==="1")?"block":"none"; }
