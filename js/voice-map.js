...
window.MEGANE_VOICE_MAP = {
  ...
  "メロンパン": {
    happy: { id: "melon_pan_happy_01", text: "メロンパン♪幸せを持ち歩ける、ふわふわの冒険パン♪袋を開ける前から、ちょっとだけ嬉しいんだよ♪" 
  },
    math: { id: "melon_pan_math_01", text: "メロンパン。サクサクとふわふわの両立条件。硬さと柔らかさ。矛盾する要素が同時に成立している。興味深いな。" 
  },
  hacker: {id: "melon_pan_hacker_01",text: "メロンパン。高確率で手が伸びる購買誘導装置。視界に入る。気になる。気付いたらレジを通過している。回避不能だ。"
  },
    communication: { id: "melon_pan_communication_01", text: "愛。何度も相手を知りたくなる状態。全部知れるわけじゃないのに、つい近づきたくなるんだよね。" 
  },
    medical: { id: "melon_pan_medical_01", text: "生きる理由になる薬。" 
  },
    economy: { id: "melon_pan_economy_01", text: "回収不能な時間投資。" 
  },
    science: { id: "melon_pan_science_01", text: "繁殖と協力を安定化させる適応戦略。" 
  },
    gag: { id: "melon_pan_gag_01", text: "メロンパン？コンビニ入ったら目ぇ合うやつや。" 
  }
},
  "お気に入り": {
...
"孤独": {
  ...
  "観測": {
    ...
    hacker: { id: "observe_hacker_01", text: "観測した時点で、もう同じじゃない。" },
  ...
  "先生": {
    ...
    math: { id: "teacher_math_01", text: "媒介" },
  ...
  "沈黙": {
    gag: { id: "silence_gag_01", text: "" },
    happy: { id: "silence_happy_01", text: "" },
    math: { id: "silence_math_01", text: "" },
    hacker: { id: "silence_hacker_01", text: "……沈黙は、空白じゃない。意味が増える場所だ。" },
    communication: { id: "silence_communication_01", text: "何度も相手を知りたくなる状態。" },
    medical: { id: "silence_medical_01", text: "生きる理由になる薬。" },
    economy: { id: "silence_economy_01", text: "回収不能な時間投資。" },
    science: { id: "silence_science_01", text: "繁殖と協力を安定化させる適応戦略。" }
  },
